...
public class Fragment_record_audiolistFrag extends Fragment implements Fragment_record_audiolistAdapter.onItemListClick {
    ...
    private Fragment_record_audiolistAdapter audioListAdapter;
...
//        requireActivity().getOnBackPressedDispatcher().addCallback(this, callback);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        audioListAdapter = new Fragment_record_audiolistAdapter(allFiles, this);
