...
public class Async_post_mqtt_health extends AsyncTask<Void, Void, String>{
    private final WeakReference<Context> contextRef;
    String uid, name, dob, gender,phone;
    int type;
    JSONObject health;

    public Async_post_mqtt_health(Context context, String[] user_info, int type, JSONObject health) {
